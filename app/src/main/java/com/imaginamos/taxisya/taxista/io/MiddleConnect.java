...
import com.imaginamos.taxisya.taxista.activities.InicialActivityLogin;
...
public class MiddleConnect {
    ...
    public static void enableDrive(Context context, double lat, double lng, String driver_id, String uuid, AsyncHttpResponseHandler responseHandler) {
       ...
       // Connect.post(context.getResources().getString(R.string.enable_driver, driver_id),null, responseHandler);
    ...
    public static void checkStatusService(Context context, String id_driver,String service_id,String uuid, AsyncHttpResponseHandler responseHandler) throws JSONException {

        RequestParams params = new RequestParams();
        Log.v("checkStatusService","service_id = " + service_id + "id_driver =" + id_driver);
